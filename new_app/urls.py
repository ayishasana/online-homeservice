...
urlpatterns = [
    ...
    path("view_filtered_workersdata", views.view_filtered_workersdata, name="view_filtered_workersdata"),
    path("update_workersdata/<int:id>/", views.update_workersdata, name="update_workersdata"),
